/**
 * Command-side application layer — use cases orchestrating the domain through ports (declared
 * here), with optimistic-concurrency append and bounded retry (D1-04/D1-05). No framework, no HTTP.
 */

export { NO_STREAM, ConcurrencyError } from "./ports.ts";
export type { AppendResult, EventStore, IdGenerator, ReadResult } from "./ports.ts";
